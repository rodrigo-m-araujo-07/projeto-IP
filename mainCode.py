...
while main:
    ...
    if len(grupoInimigo) == 0:
        enemy04 = Inimigo(0, deltaTime, pos=(670, 200), velocidade=(500, 500), vida=200, limites_mov=(500, 1000, 200, 600), sentido_inicial="0", tipo_bala = "follow", dDisparo=3)
        grupoInimigo.add(enemy04)
